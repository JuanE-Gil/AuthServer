...
public class ClientService implements RegisteredClientRepository {
	...
	public MessageDto create(CreateClientDto dto) {
		...
		return new MessageDto("cliente: " + client.getClientId() + " Guardado con exito");
	}

	private Client clienteFromDto(CreateClientDto dto) {
		return Client.builder().clientId(dto.getClientId())
				...
				.scopes(dto.getScopes()).requiredProofKey(dto.isRequiredProofKey()).build();
	}
